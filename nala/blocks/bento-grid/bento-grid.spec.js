...
module.exports = {
  ...
  features: [
    ...
    },
    {
      ...
      path: pagePath('/drafts/nala/blocks/bento-grid/bento-grid?martech=off'),
      description: 'Stage-locked: secondary cards carry the featured light-grey background on mobile; on desktop they are transparent (Figma desktop grey not yet built).',
    ...
    },
    {
      ...
      path: pagePath('/drafts/nala/blocks/bento-grid/bento-grid?martech=off'),
      description: 'Card corner radius matches the radius of the creative image it contains.',
      tags: '@bento-grid @bacom @regression @iswa-v2',
    },
  ],
};
