...
npx playwright test --config=./playwright.config.js ${TAGS} ${EXCLUDE_TAGS} --project=da-bacom-live-chromium --project=da-bacom-live-firefox --project=da-bacom-live-webkit ${REPORTER} || EXIT_STATUS=$?
