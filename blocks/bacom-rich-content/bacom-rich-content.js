...
let decorateViewportContent;
let createTag;
let getFederatedUrl;
let scrollToHashedElement;
...
export default async function init(el) {
  ({ decorateBlockText, decorateViewportContent } = await import(`${LIBS}/utils/decorate.js`));
  ({ createTag, getFederatedUrl, scrollToHashedElement } = await import(`${LIBS}/utils/utils.js`));
