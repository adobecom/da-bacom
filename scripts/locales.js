...
// Extracted from scripts.js so that tools (e.g. paths-config.js) can import
// locale data without triggering the DOM side effects in scripts.js
// (loadStyles, loadPage, etc.). Any locale additions must be made here only.
const LOCALES = {
